...
public class PaymentUpdateDto {
    ...
    [Range(0, decimal.MaxValue, ErrorMessage = "Total amount must be a positive decimal.")] 
    public decimal? total_amount { get; set; }

    // TO-DO no idea what this field is, so no validation for you
    public decimal? order_amount { get; set; }

    [Range(0, decimal.MaxValue, ErrorMessage = "Tip amount must be a positive decimal.")] 
